...
Musical co-conspirators Kieran, my fellow sick kids of edinburgh (Max, Valerie and Doris) as well as Dani. %(whose inability to finish things rivals my own, proof that we are twins after all)
...
% chapter 6+
\chapter[Interacting pressures of variation and selection]{The big picture: interacting pressures of variation and selection}%and the generation of linguistic variants
\label{ch:bigpicture}
...
\index{selection|seealso{interactor selection, replicator selection}} 
\printindex
