...
\section{Language change and the question of adaptation}\index{adaptation}
...
For example, the entire introductory chapter of \citet{Labov2001} is dedicated to what he calls the \emph{Darwinian paradox}: \index{Darwinian paradox}
% TODO quote

This approach is largely echoed by \citet{Croft200?}, who concludes that ``''~(p.?).
