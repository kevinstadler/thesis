...
The origin of the \emph{logistic curve} as the idealised can be traced back to~\citet{Altmann1983}, from where it was perpetuated by Andy Kroch~(\citeyear{Kroch1982,Kroch1989a,Kroch1989b}).
...
growth curve modelling~\citep{Winter2016}
