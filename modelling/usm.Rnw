\section{The Utterance Selection Model of language change}\index{Utterance Selection Model}
\label{sec:usm}
...
\subsection{Replicator selection}\index{selection!replicator selection}\label{sec:usmreplicator}

\subsection{Interactor selection}\index{selection!interactor selection}
